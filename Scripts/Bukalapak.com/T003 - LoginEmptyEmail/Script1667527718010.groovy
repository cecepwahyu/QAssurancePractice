...
WebUI.setText(findTestObject('Bukalapak.com/Page_Login ke Akun  Bukalapak/input_Nomor handphone atau email'), '')

WebUI.click(findTestObject('Bukalapak.com/Page_Login ke Akun  Bukalapak/button_Lanjut'))

WebUI.verifyElementText(findTestObject('Bukalapak.com/Notifikasi_test/p_Form harus diisi dulu ya'), 'Form harus diisi dulu ya')
